...
\begin{proof}\footnote{I struggled with this proof, and I am not too confident in it. I should review this!}
    Assume $z_n \in \sigma(T) \setminus \{0\}.$ Applying our last result, we have that $z_n$ is an eigenvalue of $T.$ 
...
\begin{proof}
    ...
    \end{equation}
Since $\sigma(T)$ is compact, it is closed and bounded. Furthermore, $\left\{z \in \mathbb{C} \mid |z|\ge \frac{1}{n} \right\}$ is a closed set. 
...
When $A$ is normal, the $\epsilon$-pseudospectrum is the union of open $\epsilon$-balls about the point in the spectrum of $A.$ This behaviour is depicted in Figure \ref{compare}. Equivalently, the resolvent norm satisfies $\|(A-zI)^{-1}\| = 1 / \text{dist}(z, \sigma(A)).$ 
