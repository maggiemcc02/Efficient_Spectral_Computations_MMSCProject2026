...
\cite[footnote~2, p.~130]{Colbrook2026}.} \pef{This doesn't make any sense as a general setting to propose.}  From here $A$ is the \emph{weak}
operator \pef{What does that mean? We're trying to explain things here.}, related to the endomorphism of \cref{sec:setting} by $\Astr = M^{-1}A$,
...
free.
\pef{This is 100\% AI. Please rewrite things in your own words, I think the AI prose is poor. What on earth are the two steps? It doesn't make any sense. The words are English words and the sentences are grammatical but they don't mean anything.}
