...
\begin{figure}[htbp]
    ...
    % Main figure
    \includegraphics[width=1.0\textwidth]{images/poisson_sweeps_combined.png}
    ...
    \begin{minipage}[t]{0.66\textwidth}
        \vspace{-0.03pt}
        \setlength{\abovecaptionskip}{0pt}
        \caption[The Computed $\epsilon = 0.2$ Pseudospectral Picture for the One-Dimensional Dirac Operator]{
            Outer-refinement levels $k=0,3,6$ for
            \Cref{outerloop} applied to the  $\epsilon = 0.2$ pseudospectrum of the Dirac operator
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \vspace{0pt}
        \centering
        \includegraphics[width=\textwidth]{images/poisson_zoom_standalone.png}
    \end{minipage}
