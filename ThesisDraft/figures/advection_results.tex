...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.68\textwidth}
        ...
        \caption[The Computed $\epsilon = 0.5$ Pseudospectral Picture for the One-Dimensional Advection--Diffusion Operator]{
            Outer-refinement levels $k=0,3,7$ for
            \mbox{\Cref{outerloop}} applied to the $\epsilon = 0.5$ pseudospectrum of the advection--diffusion operator \eqref{advect}.
            ...
            \cite{PseudospectraJL}. A magnified view of the $\mathcal{T}_7$ result over $[1.8,5.1]\times[-1.6,1.6]$ is shown to the right.}
    \end{minipage}
    \hfill
