...
\end{tikzpicture}
\caption[A Representative Triangulation of the Complex Plane]{A representative triangulation of the complex plane. As shown in purple, the collection of barycentres for each triangle forms $\operatorname{Grid} \subset \mathbb{C}$ for Colbrook's algorithm, Algorithm \ref{pseudospec}. As shown in green, each triangle is indexed by $K,$ with corresponding barycentre $z_K.$}
\label{Triang}
\end{figure} 
