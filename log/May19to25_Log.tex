...
\title{Logs from May $19^{\text{th}}$ to the $25^{\text{th}}$}
\author{}
\date{}
...
\begin{itemize}
    ...
    \item Today was a travel day. I worked on finishing up some proofs on the plane. 
\end{itemize}
...
\begin{itemize}
    \item Today was my family's event. Before the event, I finished up some proofs and started writing up the pseudospectra section.
...
\begin{itemize}
    ...
    \item Took a while to figure out how to create unstructured meshes. I used Chat to help with \texttt{gmsh}. Not sure if I should use \textt{netgen} or \texttt{gmsh} for the unstructured square meshes. Not sure how to pick a desired number of DOF in \texttt{netgen}. How did Boffi construct their meshes? 
    ...
    \item At some point, I want to spend some time looking through SLEPc to try and understand the solvers more. 
\end{itemize}
