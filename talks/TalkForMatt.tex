...
\begin{column}{0.48\textwidth}
    \only<3->{%
        \includegraphics[width=0.95\linewidth]{dist_plot_N=32 (2).pdf}
    }
\end{column}
\begin{column}{0.48\textwidth}
    \only<4->{\includegraphics[width=0.95\linewidth]{talks/dist_plot_N=128 (3).pdf}}
\end{column}
\end{columns}
...
\begin{itemize}
    \item<1-> Let $A$ be self-adjoint, as is the case for the folded operator.
...
\begin{center}
    \only<1>{%
        \includegraphics[width=0.5\linewidth]{talks/plot1_N=32.pdf}
    }
    \only<2>{%
        \includegraphics[width=0.5\linewidth]{talks/plot2_N=32.pdf}
    }
    \only<3>{%
        \includegraphics[width=0.5\linewidth]{talks/plot3_N=32.pdf}
    }
\end{center}
