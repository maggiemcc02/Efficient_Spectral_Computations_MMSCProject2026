...
In finite dimensions, $A$ is an $n\times n$ matrix and $\operatorname{Sp}(A)$ is the set of eigenvalues of $A$:
\[
\operatorname{Sp}(A)
=
\left\{
...
\begin{scope}[shift={(0,0)}]
    ...
    \node at (\W/2,0.25) {\(\operatorname{Sp}(A_n)\)};
...
\begin{scope}[shift={(0,-3.7)}]
    ...
    \node at (7.68,0.25) {\(\operatorname{Sp}(A_n)\)};
...
\uncover<2->{$\approx 10^{-16}$}
&
\uncover<3->{$\approx 10^{-16}$}
&
\uncover<4->{$\approx 10^{-16}$}
&
\uncover<5->{$0$}
\\
...
\begin{frame}{Tentative project timeline: May--August 2026}
\scriptsize
...
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm} Learned about the spectra and pseudospectra of operators.\end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{2}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm}Learned about approximating spectra with the finite element method.
\end{minipage}
\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{3}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm} Implemented examples using Firedrake.\end{minipage}\par\vspace{0.015cm}
...
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineTheory, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm} Literature review of Colbrook's algorithm, adaptive eigensolvers, and multilevel methods.\end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{5}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineModel, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm}Implement each method. \end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{6}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm}Explore the combination of Colbrook's algorithm with an adaptive eigensolver.\end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{7}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm} Explore the addition of a multilevel method.\end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{8}}\hspace{0.07cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm}Construct representative examples and results for the report.\end{minipage}\par\vspace{0.015cm}

\noindent\textbf{\textcolor{OxfordBlue}{9}}\hspace{0.035cm}
\noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
\hspace{0.08cm}\begin{minipage}[t]{4.45cm} Write the report.\end{minipage}\par\vspace{0.015cm}
\end{column}
...
\node[font=\scriptsize\bfseries] at (8.5,0.72) {Weekly review};

% Month and week headers
\foreach \x/\lab in {2.5/May,6.5/June,10.5/July,14.5/August}{
\node[font=\scriptsize\bfseries, text=OxfordBlue] at (\x,0.10) {\lab};
}
\foreach \x in {4.5,8.5,12.5}{
\draw[TextGrey!35] (\x,-0.20) -- (\x,-9.30);
}
\foreach \w in {1,...,16}{
...
% Row numbers
\foreach \n/\y in {1/-1.10,2/-2.10,3/-3.10,4/-4.10,5/-5.10,6/-6.10,7/-7.10,8/-8.10,9/-9.10}{
\node[anchor=east, font=\tiny, text=OxfordBlue] at (0.35,\y) {\n};
}

% Background grid
\foreach \y in {-1.10,-2.10,-3.10,-4.10,-5.10,-6.10,-7.10,-8.10,-9.10}{
\foreach \w in {1,...,16}{
...
% Multilevel method
\foreach \w in {11,12,13,14}{
\draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.45pt]
(\w-0.46,-7.49) rectangle (\w+0.46,-6.71);
}

% Examples/results
\foreach \w in {11,12,13,14,15,16}{
\draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.45pt]
(\w-0.46,-8.49) rectangle (\w+0.46,-7.71);
}

% Write report
\foreach \w in {13,14,15,16}{
\draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.45pt]
(\w-0.46,-9.49) rectangle (\w+0.46,-8.71);
}
...
% \noindent\textbf{\textcolor{OxfordBlue}{6}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% \hspace{0.08cm}\begin{minipage}[t]{4.45cm}Explore the combination of Colbrook's algorithm with an adaptive eigensolve.\end{minipage}\par\vspace{0.015cm}
...
% \noindent\textbf{\textcolor{OxfordBlue}{8}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% \hspace{0.08cm}\begin{minipage}[t]{4.45cm} Construct exemplary examples and results for the report.\end{minipage}\par\vspace{0.015cm}
...
% % Implement each method
% \foreach \w in {5,6,7,8,9,10,11,12}{
%   \draw[fill=TimelineModel, draw=OxfordBlue, line width=0.45pt]
%     (\w-0.46,-5.49) rectangle (\w+0.46,-4.71);
% }
...
% % \vspace{-0.1cm}
% % \begin{center}
% % \textcolor{TextGrey}{\scriptsize This is a tentative plan and may be revised.}
% % \end{center}
...
% \begin{frame}{Project timeline: May--August 2026}
% \scriptsize
...
% \noindent\textbf{\textcolor{OxfordBlue}{1}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% \hspace{0.08cm}\begin{minipage}[t]{4.45cm} Read about the spectra of operators.\end{minipage}\par\vspace{0.015cm}
% \noindent\textbf{\textcolor{OxfordBlue}{2}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% \hspace{0.08cm}\begin{minipage}[t]{4.45cm}Read about approximating spectra with the finite element method.
% \end{minipage}
% \par\vspace{0.015cm}
% \noindent\textbf{\textcolor{OxfordBlue}{3}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineDone, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
...
% % \noindent\textbf{\textcolor{OxfordBlue}{5}}\hspace{0.07cm}
% % \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineModel, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% % \hspace{0.08cm}\begin{minipage}[t]{4.45cm} Implement Colbrook's algorithm.\end{minipage}\par\vspace{0.015cm}
% \noindent\textbf{\textcolor{OxfordBlue}{5}}\hspace{0.07cm}
% \noindent\tikz[baseline=-0.45ex]\draw[fill=TimelineModel, draw=OxfordBlue, line width=0.35pt] (0,0) rectangle (0.17,0.17);
% \hspace{0.08cm}\begin{minipage}[t]{4.45cm}Implement each method. \end{minipage}\par\vspace{0.015cm}
% \noindent\textbf{\textcolor{OxfordBlue}{6}}\hspace{0.07cm}
...
% }
% \foreach \x in {4.5,8.5,12.5}{
%   \draw[TextGrey!35] (\x,-0.20) -- (\x,-10.30);
% }
% \foreach \w in {1,...,16}{
%   \node[text=TextGrey] at (\w,-0.45) {\w};
% }
...
% % Row numbers
% \foreach \n/\y in {1/-1.10,2/-2.10,3/-3.10,4/-4.10,5/-5.10,6/-6.10,7/-7.10,8/-8.10,9/-9.10,10/-10.10}{
%   \node[anchor=east, font=\tiny, text=OxfordBlue] at (0.35,\y) {\n};
% }

% % Background grid
% \foreach \y in {-1.10,-2.10,-3.10,-4.10,-5.10,-6.10,-7.10,-8.10,-9.10,-10.10}{
%   \foreach \w in {1,...,16}{
%     \draw[fill=TextGrey!8, draw=TextGrey!25, line width=0.25pt]
%       (\w-0.46,\y-0.39) rectangle (\w+0.46,\y+0.39);
%   }
...
%     (\w-0.46,-6.49) rectangle (\w+0.46,-5.71);
% }
% \foreach \w in {8,9,10,11,12}{
%   \draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.45pt]
%     (\w-0.46,-7.49) rectangle (\w+0.46,-6.71);
% }
% \foreach \w in {9,10,11,12,13,14}{
%   \draw[fill=TimelineVerify, draw=OxfordBlue, line width=0.45pt]
%     (\w-0.46,-8.49) rectangle (\w+0.46,-7.71);
% }
% \foreach \w in {11,12,13,14,15,16}{
...
% \foreach \w in {13,14,15,16}{
%   \draw[fill=TimelineWrite, draw=OxfordBlue, line width=0.45pt]
%     (\w-0.46,-10.49) rectangle (\w+0.46,-9.71);
% }
