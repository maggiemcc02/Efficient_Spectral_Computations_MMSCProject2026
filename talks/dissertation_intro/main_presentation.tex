...
The standard approach in infinite dimensions is to discretise $A$ with an $n$-dimensional operator, $A_h,$ and argue that $\text{Sp}(A_h)$ approaches $\text{Sp}(A).$
...
Let $V = H_0(\operatorname{rot};U)$ and $U = (0, \pi)^2.$ The variational formulation of the Maxwell eigenproblem is to find $\omega\in\mathbb R\setminus\{0\}$ and nonzero $\mathbf E \in V$ such that
...
$$ 
Standard Lagrange continuous piecewise linear elements produce spectral pollution:
...
\begin{minipage}{0.32\textwidth}
    \centering
    {\footnotesize \(N=4\)}
    \includegraphics[width=\textwidth]{Maxwell_CG1_N4.png}
\end{minipage}
\hfill
\begin{minipage}{0.32\textwidth}
    \centering
    {\footnotesize \(N=8\)}
    \includegraphics[width=\textwidth]{Maxwell_CG1_N8.png}
...
\begin{minipage}{0.32\textwidth}
    \centering
     {\footnotesize \(N=16\)}
    \includegraphics[width=\textwidth]{Maxwell_CG1_N16.png}
